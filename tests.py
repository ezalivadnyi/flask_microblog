...
class UserModelCase(unittest.TestCase):
    def setUp(self):
        self.application_instance = create_app(TestConfig)
        self.application_context = self.application_instance.app_context()
